...
class MongoStorage(BaseStorage):
    ...
    def set_study_user_attr(self, study_id, key, value):
        ...
        self.db.study.update({"study_id":study_id},{"$set":{"system_attrs":study.sytem_attrs}})
    ...
    def set_study_direction(self, study_id, direction):
        ...
        self.db.study.update({"study_id":study_id},{'$set': {'direction': direction.value}})
    ...
    def get_study_direction(self, study_id):
        ...
        study = self.db.study.find_one({'study_id': study_id})
        return structs.StudyDirection(study["direction"])
    ...
    def create_new_trial(self, study_id, template_trial=None):
        ...
        new_trial = {
            ...
            "number":new_number,
            "study_id":study_id,
            "state":structs.TrialState.RUNNING.value,
            "value":None,
    ...
    def set_trial_state(self, trial_id, state):
        ...
        print("set_trial_state",trial_id,state,state.value)
    ...
    def get_trial_number_from_id(self, trial_id):
        # type: (int) -> int
        print("get_trial_number_from_id",trial_id)
        trial = self.db.trial.find_one({"trial_id": trial_id})
        print("trial",trial)
        return trial["number"]
